...
class TalariaWiFiDriver final : public WiFiDriver
{
public:
    class WiFiNetworkIterator final : public NetworkIterator
    {
    public:
        WiFiNetworkIterator(TalariaWiFiDriver * aDriver) : mDriver(aDriver) {}
    ...
    static TalariaWiFiDriver & GetInstance()
    {
        static TalariaWiFiDriver instance;
        return instance;
    }
    void SetssidPasswordPresent(bool val);
    bool GetssidPasswordPresent();
...
private:
    ...
    bool ssidPasswordPresent = false;
};
