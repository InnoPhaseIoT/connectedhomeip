...
{
private:
    int get_entery_count();

protected:

public:
    void init();
    void get_kv_from_storage(int index);
    void put_kv_to_storage(int index);
    void sync_kv_to_storage();
    void sync_kv_from_storage();
...
private:
    // ===== Members_Put for internal use by the following friends.
