...
class TalariaFactoryDataProvider : public CommissionableDataProvider,
                                 public Credentials::DeviceAttestationCredentialsProvider    ,
                                 public Internal::GenericDeviceInstanceInfoProvider<Internal::TalariaConfig>
{
public:
    TalariaFactoryDataProvider() :
        CommissionableDataProvider(), Credentials::DeviceAttestationCredentialsProvider()
        ,
        Internal::GenericDeviceInstanceInfoProvider<Internal::TalariaConfig>(ConfigurationManagerImpl::GetDefaultInstance())
    {}
