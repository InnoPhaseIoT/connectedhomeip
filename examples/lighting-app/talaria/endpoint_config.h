...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x80), 0x00000004, 1, ZAP_TYPE(BITMAP8), 0 }, /* NameSupport */  \
  { ZAP_LONG_DEFAULTS_INDEX(14), 0x00000005, 8, ZAP_TYPE(NODE_ID), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* LastConfiguredBy */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 21, 245 }, \
  { ZAP_CLUSTER_INDEX(21), 8, 130 }, \
}
