...
int Read_Update_Thermostat_Temperature();


static void Thermostat_Temp_Init(void)
{
    if (Read_Update_Thermostat_Temperature() != 0)
    {
	    ChipLogError(DeviceLayer, "Thermostat Temperature Init failed");
    }
}
