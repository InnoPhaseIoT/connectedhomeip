...
-   [CHIP Linux Lighting Example](#chip-linux-light-switch-example)
    -   [Building](#building)
...
-   Running
    ...
    -   [Optional] Plug USB Bluetooth dongle
        ...
        -   Run Linux Lighting Example App
                  ...
                  $ cd ~/connectedhomeip/examples/light-switch-app/linux
                  $ sudo out/debug/chip-light-switch-app --ble-device [bluetooth device number]
                  # In this example, the device we want to use is hci1
                  $ sudo out/debug/chip-light-switch-app --ble-device 1
